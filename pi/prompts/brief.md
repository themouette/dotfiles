...
Use a **delegate** subagent to produce a first draft of `main.md` in the same directory as the brief file.
...
Once the user responds, use a **delegate** subagent to update `main.md`:
- Fill in the answers
